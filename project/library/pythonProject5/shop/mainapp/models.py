        ...
        if with_respect_to:
            ...
            if ct_model.exists():
                if with_respect_to in args:
                    return sorted(
                        products, key = lambda x: x.__class__._meta.model_name.starstwith(with_respect_to), reverse=True
                    )
...
class Notebook(Product):
    ...
    time_without_charge = models.CharField(max_length=255, verbose_name='Время работы эмулятора')
...
class Smartphone(Product):
    ...
    accum_volume = models.CharField(max_length=255, verbose_name='Емкость аккамулятора')
    ram = models.CharField(max_length=255, verbose_name='Оперативная память')
